...
namespace limine
{
    ...
    extern "C"
    {
        ...
        __attribute__((used, section(".limine_requests"))) //
        inline volatile limine_memmap_request mem_map      //
            = {.id = LIMINE_MEMMAP_REQUEST_ID,             //
               .revision = 0,
               .response = nullptr};

        __attribute__((used, section(".limine_requests"))) //
        inline volatile limine_rsdp_request rsdp           //
        ...
        __attribute__((used, section(".limine_requests")))          //
        inline volatile limine_executable_address_request exec_addr //
        ...
        __attribute__((used, section(".limine_requests")))       //
        inline volatile limine_executable_file_request exec_file //
